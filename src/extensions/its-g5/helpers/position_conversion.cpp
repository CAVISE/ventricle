...
namespace vcle::itsg5 {
	vanetza::PositionFix toPositionFix(
		...
		fix.course = vanetza::ConfidentQuantity<vanetza::units::TrueNorth>(vanetza::units::TrueNorth::from_value(heading));
		fix.speed = vanetza::ConfidentQuantity<vanetza::units::Velocity>(vanetza::units::Velocity::from_value(std::hypot(velocity.x, velocity.y)));
		fix.altitude = vanetza::ConfidentQuantity<vanetza::units::Length>(vanetza::units::Length::from_value(position.z));
		return fix;
	}
} // namespace vcle::itsg5
