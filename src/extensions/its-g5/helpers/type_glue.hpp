...
namespace vcle {
	...
	struct TypeGlueConverter<vanetza::MacAddress, ns3::Mac48Address> {
		static ns3::Mac48Address convert(vanetza::MacAddress address) {
	...
	struct TypeGlueConverter<ns3::Mac48Address, vanetza::MacAddress> {
		static vanetza::MacAddress convert(ns3::Mac48Address address) {
	...
	struct TypeGlueConverter<vanetza::Clock::duration, ns3::Time> {
		static ns3::Time convert(vanetza::Clock::duration duration) {
	...
	struct TypeGlueConverter<ns3::Time, vanetza::Clock::duration> {
		static vanetza::Clock::duration convert(const ns3::Time& duration) {
	...
	struct TypeGlueConverter<ns3::Time, vanetza::Clock::time_point> {
		static vanetza::Clock::time_point convert(const ns3::Time& time) {
